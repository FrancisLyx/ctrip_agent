...
from graph_chat.assistant import create_assistant_node, safe_tools, sensitive_tools
...
builder.add_node("tools", create_tool_node_with_fallback(safe_tools + sensitive_tools))
# 定义边：这些边决定了控制流如何移动
